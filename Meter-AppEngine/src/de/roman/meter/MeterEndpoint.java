...
public class MeterEndpoint
{
    ...
    /**
     * This method gets the meterCounts list from the entity having primary key
     * id. It uses HTTP GET method.
     * 
     * @param id
     *            the primary key of the java bean.
    ...
    public List<MeterCount> getMeterCountListWithUserId(
            @Named("UserId") Long userId, @Named("MeterId") Long meterId)
    {
        PersistenceManager mgr = getPersistenceManager();
    ...
    /**
     * This inserts a new MeterCount entity to an existing Meter into App Engine
    ...
    public MeterCount insertMeterCountToUser(@Named("UserId") long userId,
            @Named("MeterId") long meterId,
            @Named("metercountvalue") String mtrCntValue)
    {
    ...
    public Meter updateMetr(@Named("UserId") long userId,
            @Named("MeterId") long meterId, @Named("Value") String mtrCntValue,
