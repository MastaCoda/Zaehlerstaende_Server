...
public class UserEndpoint
{
    ...
    public User getUserByEmail(@Named("email") String email)
    {
        ...
        try
        {
            ...
            Query query = mgr.newQuery(User.class, "email == theEmail");
            Map<String, String> paramValues = new HashMap();
            paramValues.put("theEmail", email);
            @SuppressWarnings("unchecked")
            List<User> foundUsers = (List<User>) query
    ...
    public Meter insertMeterToUser(@Named("UserId") Long id,
            @Named("MeterDesc") String desc, @Named("MeterName") String name,
            @Named("MeterType") String type, @Named("MeterUnit") String unit)
    {
        PersistenceManager mgr = getPersistenceManager();
        User user = null;
        ...
        try
        {
            ...
            meter.setName(name);
            meter.setType(MeterTypes.valueOf(type));
            meter.setUnit(Units.valueOf(unit));
