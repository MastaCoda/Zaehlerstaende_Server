 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "roman.de", ownerName = "roman.de", packagePath="meter"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyDdhHvNTU56HCizE4RKOAnAy8gvKbG9kKM";
